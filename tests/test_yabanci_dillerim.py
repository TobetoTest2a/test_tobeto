...
class TestTobetoGiris(softest.TestCase,PageBase):
    ...
    def test_yabanci_dil_ekle(self):
        ...
        self.soft_assert(self.assertEqual, BASARILI_POPUP_TEXT, yabanci_dillerim.kaydetme_basarili(), "HATALI BASARILI MESAJI")
    ...
    def test_yabanci_dil_bos_alan_kontrolu(self):
        ...
        yabanci_dillerim.seviye_acilirmenu_tikla()
        yabanci_dillerim.kaydet()
        yabanci_dillerim.doldurulmasi_zorunlu_alan_mesaji()
